\begin{tikzpicture}[scale=0.5]    
    ...
    \fill[bluegray] (5,0) rectangle (6,1);
    \fill[bluegray] (6,0) rectangle (7,1);
    \fill[coolblack] (7,0) rectangle (8,1);
    \fill[coolblack] (8,0) rectangle (9,1);
    \fill[bluegray] (5,1) rectangle (6,2);
    \fill[bluegray] (6,1) rectangle (7,2);
    \fill[coolblack] (7,1) rectangle (8,2);
    \fill[coolblack] (8,1) rectangle (9,2);
