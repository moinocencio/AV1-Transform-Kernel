...
\begin{pgfonlayer}{background}
    \draw[fill=black!10,rounded corners, draw=black, dashed] (3.2,0.5) rectangle (8.3,-2.85);

    \node at (5.75,0.5) [align=center, anchor=south, yshift=1mm, font={\huge\bfseries}] {DCT4};
