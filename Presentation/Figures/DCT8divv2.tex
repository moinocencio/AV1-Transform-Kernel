\begin{tikzpicture}[%
  ...
  \begin{scope}[y=-1cm]
    \begin{scope}
      ...
      %% Fase 2 Mult
      \node (St2M) at (9.5,9.5) [draw,thick,minimum width=4.5cm,minimum height=3cm, rounded corners, anchor=north west, fill=black!8, font={\large\bfseries}, align=center] {Fase 2:\\Multiplicação};
