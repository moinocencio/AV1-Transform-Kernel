...
\begin{pgfonlayer}{background}
    %\draw[fill=black!2,rounded corners, draw=black!50, dashed] (3.2,0.5) rectangle (8.3,-3.65);

    \draw [thick, dashed, rounded corners] (2.2,.5) rectangle (3.5,-6.3);
        \node at (2.85,0.5) [align=center, anchor=south, yshift=1mm, font={\large\bfseries}] {Soma};
    \draw [thick, dashed, rounded corners] (8,.5) rectangle (9.3,-6.3);
        \node at (8.65,0.5) [align=center, anchor=south, yshift=1mm, font={\large\bfseries}] {Multiplicação\\Soma\\Shift};
