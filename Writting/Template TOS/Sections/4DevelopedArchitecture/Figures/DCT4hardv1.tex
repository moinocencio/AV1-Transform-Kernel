  ...
  \begin{scope}[y=-1cm]
    \begin{scope}
      ...
      \draw [black,very thick] (1,0) circle (1mm) node [right, rotate=90, xshift=1mm] {\texttt{Clock}};
        \draw [aar] (1,0.1) |- (5,19.5-1);
        \draw [aar] (1,0.1) |- (5,15.5-1);
        \draw [aar] (1,0.1) |- (5,11.5-1);
        \draw [aar] (1,0.1) |- (5,7.5-1);
        \draw [aar] (1,0.1) |- (5,3.5-1);
      \draw [black,very thick] (2,0) circle (1mm) node [right, rotate=90, xshift=1mm] {\texttt{Reset}};
        \draw [aar] (2,0.1) |- (5,19.5-1.5);
        \draw [aar] (2,0.1) |- (5,15.5-1.5);
        \draw [aar] (2,0.1) |- (5,11.5-1.5);
        \draw [aar] (2,0.1) |- (5,7.5-1.5);
        \draw [aar] (2,0.1) |- (5,3.5-1.5);
      \draw [black,very thick] (3,0) circle (1mm) node [right, rotate=90, xshift=1mm] {\texttt{Enable}};
        \draw [aar] (3,0.1) |- (5,1.5);
      \foreach \x in {0,...,3}
        \draw [black,very thick] (6+2*\x,0) circle (1mm) node [right, rotate=90, xshift=1mm] (dIn\x) {\texttt{dataIn\x}};
      

      %% In Register
      \node (inReg) at (5,2-1) [draw,thick,minimum width=8cm,minimum height=3cm, rounded corners, anchor=north west, fill=black!8, font={\large}] {\textbf{Input Register}};
      ...
      \node (valoutInReg) at (5,4.5-1) [right, font={\small}] {\texttt{valOut}};
        \draw [aar] (5,4.5-1) -- ++(-1,0) |- (5,6.5-1);

      %% Stage 1 Sum
      \node (St1) at (5,6-1) [draw,thick,minimum width=8cm,minimum height=3cm, rounded corners, anchor=north west, fill=black!8, font={\large}] {\textbf{Stage 1: Sum}};
      ...
      \node (valoutSt1) at (5,8.5-1) [right, font={\small}] {\texttt{valOut}};
        \draw [aar] (5,8.5-1) -- ++(-1,0) |- (5,10.5-1);

      %% Stage 2 Mult
      \node (St2M) at (5,10-1) [draw,thick,minimum width=8cm,minimum height=3cm, rounded corners, anchor=north west, fill=black!8, font={\large}] {\textbf{Stage 2: Multiplier}};
      ...
      \node (valoutSt2M) at (5,12.5-1) [right, font={\small}] {\texttt{valOut}};
        \draw [aar] (5,12.5-1) -- ++(-1,0) |- (5,14.5-1);
      
      %% Stage 2 Add
      \node (St2A) at (5,14-1) [draw,thick,minimum width=8cm,minimum height=3cm, rounded corners, anchor=north west, fill=black!8, font={\large}] {\textbf{Stage 2: Sum}};
      ...
      \node (valoutSt2A) at (5,16.5-1) [right, font={\small}] {\texttt{valOut}}; 
        \draw [aar] (5,16.5-1) -- ++(-1,0) |- (5,18.5-1);
      ...
      \node (valoutSt2S) at (5,20.5-1) [right, font={\small}] {\texttt{valOut}};  
        \draw [aar] (5,20.5-1) -| (2,20.5); 
        \draw[line width=0.4mm] (2,20.5) -- ++(0, -0.4cm);
      
      %% Outputs
      \draw [black,very thick] (2,21) circle (1mm) node [left, rotate=90, xshift=-1mm] {\texttt{validOut}};
      
      \draw [black,very thick] (6,21) circle (1mm) node [left, rotate=90, xshift=-1mm] (dOut0) {\texttt{dataOut0}};
      \draw [black,very thick] (6+2*1,21) circle (1mm) node [left, rotate=90, xshift=-1mm] (dOut2) {\texttt{dataOut2}};
      \draw [black,very thick] (6+2*2,21) circle (1mm) node [left, rotate=90, xshift=-1mm] (dOut1) {\texttt{dataOut1}};
      \draw [black,very thick] (6+2*3,21) circle (1mm) node [left, rotate=90, xshift=-1mm] (dOut3) {\texttt{dataOut3}};

      \foreach \x in {0,...,3} {
        \draw[aar] (6+2*\x,-1mm) -- ++(0, -0.9cm);
        \draw[aar] (6+2*\x,4) -- ++(0, -1cm);
        \draw[aar] (6+2*\x,8) -- ++(0, -1cm);
        \draw[aar] (6+2*\x,12) -- ++(0, -1cm);
        \draw[aar] (6+2*\x,16) -- ++(0, -1cm);
        \draw[aar] (6+2*\x,20) -- ++(0, -0.5cm);
        \draw[line width=0.4mm] (6+2*\x,20.5) -- ++(0, -0.4cm);
      }
    \end{scope}
