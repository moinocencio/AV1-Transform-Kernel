  ...
  \begin{scope}[y=-1cm]
    \begin{scope}
      ...
      \draw [black,very thick] (1,0) circle (1mm) node [right, rotate=90, xshift=1mm] {\texttt{Clock}};
        \draw [aar] (1,0.1) |- (9.5,16);
        \draw [aar] (1,0.1) |- (4,10.5);
        \draw [aar] (1,0.1) -- (1,8.6) -- ++(7.7,0) |- (9.5,11.5-1);
        \draw [aar] (1,0.1) |- (4,7.5-1);
        \draw [aar] (1,0.1) |- (4,3.5-1);
      \draw [black,very thick] (2,0) circle (1mm) node [right, rotate=90, xshift=1mm] {\texttt{Reset}};
        \draw [aar] (2,0.1) |- (9.5,15.5);
        \draw [aar] (2,0.1) |- (4,10);
        \draw [aar] (2,0.1) -- (2,8.4) -- ++(6.9,0) |- (9.5,11-1);
        \draw [aar] (2,0.1) |- (4,7.5-1);
        \draw [aar] (2,0.1) |- (4,3.5-1);
      \draw [black,very thick] (3,0) circle (1mm) node [right, rotate=90, xshift=1mm] {\texttt{Enable}};
        \draw [aar] (3,0.1) |- (4,1.5);
      \foreach \x in {0,...,3}
        \draw [black,very thick] (5+\x,0) circle (1mm) node [right, rotate=90, xshift=1mm] (dIn\x) {\texttt{dataIn\x}};
      \foreach \x in {4,...,7}
        \draw [black,very thick] (6+\x,0) circle (1mm) node [right, rotate=90, xshift=1mm] (dIn\x) {\texttt{dataIn\x}};
      ...
      \node (valoutInReg) at (5-1,4.5-1) [right, font={\small}] {\texttt{valOut}};
        \draw [aar] (5-1,4.5-1) -- ++(-1,0) |- (5-1,6.5-1);
      ...
      \node (valoutSt1) at (5-1,8.5-1) [right, font={\small}] {\texttt{valOut}};
        \draw [aar] (5-1,8.5-1) -- ++(-1,0) |- (5-1,10.5-1);
        \draw [aar] (5-1,8.5-1) -- ++(-1,0) -- ++(0,0.7) -- ++(6.1,0) |- (9.5,10.5-1);
      ...
      \node (valoutSt2M) at (9.5,12.5-1) [right, font={\small}] {\texttt{valOut}};
        \draw [line width=0.4mm] (9.5,12.5-1) -- ++(-0.5,0) -- ++(0,1.5) coordinate (etc);
      ...
      %% Stage 4 Shift
      \foreach \x in {0,...,3}
        \draw [aar] (10+\x,14) -- ++(0,0.5);
      \draw [aar] (9,14) |- (9.5,15);
      ...
      \node (valoutSt2S) at (9.5,17) [right, font={\small}] {\texttt{valOut}}; 
        %\draw [aar] (9.5,20.5-1) -| (2-1,20.5); 
        
        \node[and gate,inputs={nnnn}, point down] (and1) at (1,18)    {};
            \draw[aar] (valoutSt2S) -| (and1.input 1);
            \draw[aar] (valoutDCT4) -| (and1.input 4);
            \draw[aar] (and1.output) -- (1, 19.5);
      ...
      \foreach \x in {0,...,3} {
        \draw[aar] (5+\x,-1mm) -- ++(0, -0.9cm);
        \draw[aar] (5+\x,4) -- ++(0, -1cm);
        \draw[aar] (5+\x,8) -- ++(0, -1cm);
        \draw[aar] (5+\x,12) -- ++(0, -7.5cm);       
        \draw[line width=0.4mm] (5+\x,19.5) -- ++(0, -0.4cm);
      }
      \foreach \x in {4,...,7} {
        \draw[aar] (6+\x,-1mm) -- ++(0, -0.9cm);
        \draw[aar] (6+\x,4) -- ++(0, -1cm);
        \draw[aar] (6+\x,8) -- ++(0, -1cm);
        \draw[line width=0.4mm] (6+\x,12) -- ++(0, -1cm);
        \draw[aar] (6+\x,17.5) -- ++(0, -2cm);
        \draw[line width=0.4mm] (6+\x,19.5) -- ++(0, -0.4cm);
      }
    \end{scope}
