...
\begin{figure}[!htbp]
    ...
    \caption{Timing diagram for first \emph{DCT} wrapper}
    \label{fig:v1timing}
\end{figure}
...
A simplified version of the achieved architecture is represented in Figure \ref{fig:fullv2}, where no clock or reset signals are represented.
