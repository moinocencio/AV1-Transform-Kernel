...
\usepackage{tabularx}
\usepackage{booktabs}
\usetikzlibrary{fadings,shapes,arrows,chains,backgrounds,calc,arrows,arrows.meta,shadows,shapes.geometric, fit, positioning, circuits.logic.US, circuits, decorations.markings}
...
\def\TituloTese{Co-processador da Transformada para o Codificador de Vídeo AV1}
\def\ThesisTitle{Transform Co-Processor for AV1 Video Coding Standard}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Developed Architecture
\include{Sections/5Conclusions/conclusions}
