...
for i_q = 1:size(terms,2)              % Quality Index    
    figure('Name',q(i_q)+" Vector Size"),   makePrettyBar(  ["CIF" "HD" "FHD" "UHD"], ...
                                                            squeeze(sizes_p(i_q,:,:)), ...
                                                            ["4","8","16","32","64"], ...
                                                            'Vector Size', 'Relative Use (%)');
    
    figure('Name',q(i_q)+" Kernel"),        makePrettyBar(  ["CIF" "HD" "FHD" "UHD"], ...
                                                            squeeze(types_p(i_q,:,:)), ...
                                                            ["DCT", "ADST", "FADST", "IDTX"], ...
                                                            'Transform Kernel', 'Relative Use (%)');

    figure('Name',q(i_q)+" Cosine Bits"),   makePrettyBar(  ["CIF" "HD" "FHD" "UHD"], ...
                                                            squeeze(cosbit_p(i_q,:,:)), ...
                                                            ["10","11","12","13","14", "15", "16"], ...
                                                            'Cosine bits', 'Relative Use (%)');
    
    figure('Name',q(i_q)+" Square Kernels"),makePrettyBar(  ["CIF" "HD" "FHD" "UHD"], ...
                                                            [squeeze(sqtyp_p(i_q,:)); squeeze(sqsiz_p(i_q,:))]', ...
                                                            ["Square Size" "Square Kernel"], ...
                                                            'Resolution', 'Relative Use (%)');
end
%}
figure('Name',"Average Vector Size"),   makePrettyBar(  q, ...
                                                        squeeze(mean(sizes_p,2)), ...
                                                        ["4","8","16","32","64"], ...
                                                        'Quality', 'Relative Use (%)');

figure('Name',"Average Kernel"),        makePrettyBar(  q, ...
                                                        squeeze(mean(types_p,2)), ...
                                                        ["DCT", "ADST", "FADST", "IDTX"], ...
                                                        'Quality', 'Relative Use (%)');

figure('Name',"Average Cosine Bits"),   makePrettyBar(  q, ...
                                                        squeeze(mean(cosbit_p,2)), ...
                                                        ["10","11","12","13","14", "15", "16"], ...
                                                        'Quality', 'Relative Use (%)');

figure('Name',"Average Square Kernels"),makePrettyBar(  q, ...
