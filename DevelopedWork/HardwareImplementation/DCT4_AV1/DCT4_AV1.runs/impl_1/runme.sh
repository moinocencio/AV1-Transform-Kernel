...
HD_PWD='/run/media/moinocencio/Data/Tese/Master-Thesis/DevelopedWork/HardwareImplementation/DCT4_AV1/DCT4_AV1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DCT4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DCT4.tcl -notrace
