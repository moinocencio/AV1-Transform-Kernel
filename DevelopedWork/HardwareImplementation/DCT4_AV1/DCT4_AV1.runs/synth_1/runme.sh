...
HD_PWD='/run/media/moinocencio/Data/Tese/Master-Thesis/DevelopedWork/HardwareImplementation/DCT4_AV1/DCT4_AV1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DCT4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DCT4.tcl
