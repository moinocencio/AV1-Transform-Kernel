...
\usepackage{lipsum}
\usepackage[backend=biber, refsection=chapter, sorting=none]{biblatex}
...
{\Large\bfseries}
{\thesection\hspace{10pt}\dgrayvline\hspace{10pt}}
{0pt}
{\Large\bfseries}
...
{\large\bfseries}
{\thesubsection\hspace{10pt}\grayvline\hspace{10pt}}
{0pt}
{\large\bfseries}
...
\def\TituloTese{Co-processador da Transformada e Quantização para AV1}
\def\ThesisTitle{AV1 Transform and Quantization Co-Processor}
