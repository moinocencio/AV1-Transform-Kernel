...
\tikzset{
  ...
  inout/.style={base,draw,trapezium,trapezium left angle=70,trapezium right angle=-70, fill=blue!12},
  ...
  \begin{pgfonlayer}{background}
    ...
    \node[text=blue!80!black, below=0.2cm of legend3.south west, font={\small}, anchor=west] (legend4) {Condition Set};
