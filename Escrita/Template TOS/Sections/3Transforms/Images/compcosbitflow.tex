...
\tikzset{
    ...
    proc/.style={base, rectangle, text width=1.6cm, fill=black!10, minimum height=1.5cm, minimum width=1.5cm,font={\bfseries}},    
...
\node [proc, right=3cm of regrec, fill=black!15] (psnr) {\emph{PSNR}};
    \draw[->] (regrec) -- (psnr);
