...
Therefore, the reference software was profoundly studied, especially regarding the transformation stage. 


%The different transform codecs were deconstructed into block diagrams, presented in the following sections.

%While \emph{AV1} accepts \emph{transform block} sizes varying between 4 and 64, the codec tends to be similar between the different sizes. Therefore, only the \emph{1D 8 input} codecs are presented.
