...
\todor{Add more text to DCT3 and 4}
...
Although the code implementation is sequential, the \emph{8 length} transformation kernels are represented in the following sections as parallel block diagrams, with the diverse stages in series. While \emph{AV1} accepts \emph{transform block} sizes varying between 4 and 64, the method of transformation is similar between the different sizes.

%%%%%%%%%%%%%%%%%%%
\subsubsection{Forward DCT}

\begin{figure}[h]
    \centering
    \input{Sections/3Transforms/Images/av1_fdct8_new.tex}
    \caption{Block diagram of the implemented Integer DCT}
    \label{fig:intDCT}
\end{figure}
