...
In order to test the Transformation stage, various encoding and decoding tests were performed on different resolution sequences, some of which details are presented in table \ref{tab:seqs}. These were obtained in \emph{Xiph}'s test media \cite{XiphOrgTest}.

\begin{table}[htpb]
    \centering
    \begin{tabular}{@{}ccccc@{}} \toprule
        \multirow{2}{*}{\textbf{Video}} & \multicolumn{3}{c}{\textbf{Resolution}} \\
         & \textbf{Height} & \textbf{Width} & \textbf{Label} \\ \toprule 
        \textit{Waterfall} & 288 & 352 & CIF \\
        \textit{Ducks take off} & 720 & 1280 & HD \\
        \textit{Parkjoy} & 1080 & 1920 & FHD \\
        \textit{Into tree} & 2160 & 3840 & UHD \\
        \bottomrule
    \end{tabular}
...
The reference encoder and decoder, \emph{aomenc} and \emph{aomdec}, were configured using the developer's default configurations, meaning that the compression was achieved with no bitrate objective.
