...
\begin{table}[h]
    ...
    \begin{tabular}{ccc} \toprule
        ...
        \bottomrule
    \end{tabular}
    \caption[Encoding times of different video encoders, and improvements on \emph{AV1}]{Encoding times of different video encoders, and improvements on \emph{AV1} \cite{AV1FirstLook2018a, GoodNewsAV12019}}
    \label{tab:testtime}
\end{table}
