...
\begin{figure}[!htbp]
    \centering
    \input{Sections/3AV1/Diagrams/partitioning.tex}
...
From these results, it is possible to conclude that \emph{AV1} is a promising codec, both for its open-source and royalty free usage, as well as its performance.
