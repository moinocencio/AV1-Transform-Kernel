...
\todo[inline,color=red]{Video codecs are very different from each other, making the development of newer hardware architectures mandatory}
\todo[inline,color=red]{AV1 is the most recent codec, developed by...}
